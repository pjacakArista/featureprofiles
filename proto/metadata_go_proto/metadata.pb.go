...
type Metadata_Deviations struct {
	...
	// Device requires certificate-id to be set on gRPC server when transport-security is enabled.
	// Arista: https://issuetracker.google.com/issues/XXXXXXXXX
	GrpcServerCertificateId string `protobuf:"bytes,439,opt,name=grpc_server_certificate_id,json=grpcServerCertificateId,proto3" json:"grpc_server_certificate_id,omitempty"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
...
func (x *Metadata_Deviations) GetGrpcServerCertificateId() string {
	if x != nil {
		return x.GrpcServerCertificateId
	}
	return ""
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xc4\xf7\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\x90\xed\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"3static_route_nexthop_interface_state_oc_unsupported\x18\xb6\x03 \x01(\bR-staticRouteNexthopInterfaceStateOcUnsupported\x12<\n" +
	"\x1agrpc_server_certificate_id\x18\xb7\x03 \x01(\tR\x17grpcServerCertificateIdJ\x04\bT\x10UJ\x04\b\t\x10\n" +
