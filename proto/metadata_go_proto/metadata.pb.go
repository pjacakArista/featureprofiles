...
type Metadata_Deviations struct {
	...
	GrpcServerCertificateId string `protobuf:"bytes,442,opt,name=grpc_server_certificate_id,json=grpcServerCertificateId,proto3" json:"grpc_server_certificate_id,omitempty"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xe6\xee\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x1agrpc_server_certificate_id\x18\xba\x03 \x01(\tR\x17grpcServerCertificateIdJ\x04\bT\x10UJ\x04\b\t\x10\n" +
