...
type Metadata_Deviations struct {
	...
	GribiDecapInDefaultNiUnsupported bool `protobuf:"varint,432,opt,name=gribi_decap_in_default_ni_unsupported,json=gribiDecapInDefaultNiUnsupported,proto3" json:"gribi_decap_in_default_ni_unsupported,omitempty"`
	unknownFields                    protoimpl.UnknownFields
	sizeCache                        protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	...
	"%gribi_decap_in_default_ni_unsupported\x18\xb0\x03 \x01(\bR gribiDecapInDefaultNiUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
